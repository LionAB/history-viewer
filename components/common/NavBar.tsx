        ...
        <div className="md:flex md:px-10 items-center justify-between">
            ...
            <div className="lg:block">
               {/*  <ul className="md:flex space-x-10 text-base font-bold text-black/60 dark:text-white md:pl-0 "> */}
                <ul className={`sm:max-md:drop-shadow-md md:flex  md:items-center  text-black/60   dark:text-white md:pb-0 pb-12 absolute md:static  left-0 w-full md:w-auto md:pl-0 pl-9  transition-all duration-500 ease-in ${isOpen ? 'top-12 sm:bg-background/95 md:bg-transparent sm:backdrop-blur' : ' top-[-500px] bg-transparent'} ` }>
